...
{
	public:
		QXClient( Window id, const XWindowAttributes & );
		~QXClient();
...
inline bool QXClient::isOpaque() const
{
...
inline Picture QXClient::picture()
{
	if ( !mPicture )
		createWindowPicture();
...
inline Picture QXClient::alphaMask()
{
...
inline void QXClient::destroyShapeClip()
{
	if ( mShapeClipRegion ) {
...
inline void QXClient::setShapeClip( const XserverRegion r )
{
	if ( !mShapeClipRegion )
